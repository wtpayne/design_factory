...
title:
    "ASGI web resource serving utility support module."

description:
    "This Python module is designed to support
    the generation of web resources for serving
    using the asgi.server module."

id:
    "6a35a425-87db-4a05-98d5-85603078cc9f"
